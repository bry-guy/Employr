...
namespace Resume
{
    public static class Constants
    {
        ...
        //ResumeView
        public const string ResumeDeveloperBody  = "• Xamarin Certified \r\n" +
            "• Shipped an Android app, Employr, built on Xamarin.Forms \r\n" +
            "• In process of shipping iOS version of Employr \r\n" +
            "• Experienced with Xamarin.Android, Xamarin.iOS, and Xamarin.Forms";

        public const string ResumeEngineerBody  = "• Bachelor's Degree in Civil and Environmental Engineering from the University of Michigan \r\n" +
            "• Professionally employed for 1.5 years as a Civil Engineer with OHM Advisors, Inc. \r\n" +
            "• Designed multiple infrastructure improvement projects costing from $50,000 to $1,000,000 including roads, sidewalks, and sewer improvements \r\n" +
            "• Two year Captain of the University of Michigan Steel Bridge Team, with structural design, machining, welding, and leadership experience";
    }
}
